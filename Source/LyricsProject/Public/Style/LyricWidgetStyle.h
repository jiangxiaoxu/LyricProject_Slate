...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = Appearance)
	TEnumAsByte<EStretchDirection::Type>	   BackGroundStretchDirection;

	FLyricWidgetStyle()
		:BackGroundStretchType(EStretch::ScaleToFill),
		BackGroundStretchDirection(EStretchDirection::Both)
	{}
};
